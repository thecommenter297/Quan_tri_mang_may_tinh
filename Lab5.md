...
*   **Active Directory:** Các OU `HANOI\IT` và `HANOI\Sale`, cùng các nhóm (`GG_S_IT`, `GG_S_Sale`) và người dùng (`hungnq`, `nghialv`) đã được tạo từ Lab 3.
...
1.  Trên máy `FILESRV01`, mở **File Explorer** và tạo cấu trúc thư mục sau: `C:\Data\IT` và `C:\Data\Sale`.
