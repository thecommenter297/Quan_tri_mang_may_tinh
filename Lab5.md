...
*   **Máy chủ File Server:** Một máy Windows Server 2019 mới, đặt tên là `FILESRV01`, IP: `192.168.1.101`, đã gia nhập vào miền `bkaptech.vn`. (Hoặc dùng máy DC luôn cũng được)
...
<h4>Tạo OU HANOI\IT và HANOI\SALE bằng Powershell nếu chưa tạo</h4>
